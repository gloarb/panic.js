$( document ).ready(function() {
    ...
    var pageName;
    var iconUrl;
    $('body').append('<button id="btnPanic" style="border-radius: 100px;background: #000;opacity: 0.3;filter: alpha(opacity=30);text-align: center;border: none;width: 75px;height: 75px;color: #fff;position:fixed;'+position+'cursor:pointer;z-index: 3001;">Panic!</button>');
